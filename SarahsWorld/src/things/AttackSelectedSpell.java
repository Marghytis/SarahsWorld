...
public class AttackSelectedSpell extends AttackSelected {
	...
	public void attackSelected(Thing src, Thing[] targets, int amount, ItemType item) {
		...
		WorldWindow.addEffect(new RainbowSpit(new Vec(!src.dir? src.ani.tex.info[0][0] : (src.ani.tex.w-src.ani.tex.info[0][0]), src.ani.tex.info[0][1]).shift(src.pos).shift(src.box.pos), src.dir? 1 : -1, src, targets, damages, effect));
	}
