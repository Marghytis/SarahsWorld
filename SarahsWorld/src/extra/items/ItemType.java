...
import extra.Main;
import extra.Res;
import extra.effects.particleEffects.BerryEat;
import extra.effects.particleEffects.FireEffect;
...
public class ItemType {
	...
	public static final ItemType UNICORN_HORN	= new ItemType(builder.readItemType("UNICORN_HORN")) {
		...
		public boolean useAt(Thing src, Vec pos) {
			ColumnListElement c = Main.game().world.landscapeWindow.at(pos.x);
			if(c != null) {
				Vec loc = new Vec();
