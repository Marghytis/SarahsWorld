...
public enum ThingType {
	...
	SARAH(Res.sarah) {
		...
		public Thing create(WorldData world, Vertex field, Vec pos, Object... extraData) {
			...
			t.ground = new Grounding(t, true, 0, field, standing,	 walking,	 sprinting,		jumping,		flying,		landing);
	...
	CLOUD(Res.cloud) {
		...
		public Thing create(WorldData world, Vertex field, Vec pos, Object... extraData){
			...
			t.vel = new Velocity(t);
			t.ground = new Grounding(t, false, -height, field, cloud, cloud, cloud, cloud, cloud, cloud);
			t.ground.speed = 10;
