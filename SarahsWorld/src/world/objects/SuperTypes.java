...
public enum SuperTypes {
	TREE(ThingType.TREE_NORMAL, ThingType.TREE_FIR, ThingType.TREE_FIR_SNOW, 
		...
		public void create(World world, WorldField field, Vec pos, ThingType type, Object... extraData){
	...
	public abstract void create(World world, WorldField field, Vec pos, ThingType thingType, Object... extraData);
}
