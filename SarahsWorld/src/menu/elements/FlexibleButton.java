...
import menu.elements.FlexibleTextField.StringProducer;
...
public abstract class FlexibleButton extends TextField {
	...
	public FlexibleButton(SarahsWorld game, StringProducer text, double relX1, double relY1, double relX2, double relY2, int x1, int y1, int x2, int y2, Color color1, Color color2, Texture tex1, Texture tex2) {
	...
	public void render() {
		if(contains(Main.game().input2.getMousePos())){
			color = c2;
			tex = t2;
		} else {
			color = c1;
