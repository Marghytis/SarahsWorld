...
public class CommandInput extends TextInput {
	...
	static {
		...
		commands.put("setMenu", args -> Main.game().menu.setMenu(MenuType.valueOf(args[0])));
		...
		String enable = "";
		for(String boo : Settings.getBooleanKeys()) {
			enable += "\nenable " + boo;
		}
	...
	public CommandInput(SarahsWorld game, String text, double relX1, double relY1, double relX2, double relY2, int x1, int y1,
