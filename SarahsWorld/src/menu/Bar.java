...
public class Bar extends Element {
	...
	public Bar(Main game, double relX1, double relY1, double relX2, double relY2, int x1, int y1, int x2, int y2, Color color, Texture tex, boolean showX, ValueGetter valueGetter) {
